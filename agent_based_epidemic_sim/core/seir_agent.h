...
class SEIRAgent : public Agent {
 ...
 private:
  ...
  // Before we send any test results last_contact_report_considered_ is
  // set to an invalid contact (one that occurred at infinite past.) and
  // last_test_result_sent_ is set to a result that was requested at infinite
  // future.
